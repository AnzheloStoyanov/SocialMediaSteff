...
export default function ServicesContainer({ content }) {
  ...
  return (
    <div
      ...
      className="home-services-main-container"
    >
      <div>
        <h6>Strategy & Conception</h6>
        <p>
          Всяка стратегия е изцяло персонализирана за нуждите и целите на твоя
          бранд въз основа на доказано работещи практики в платформата TikTok.
        </p>
      ...
      {!isMobile && (
        <div className="reverse-col">
          ...
          <p>
            Ние сме връзката между бранда ти и новото поколение крийтъри, които
            аудиторията харесва и следи.
          </p>
          <div className="spacer"></div>
          <div className="big-pink">
            <div className="small-pink">
      ...
      {!isMobile && (
        <div className="reverse-col">
          ...
          <p>
            Ако брандът ти има нужда просто от насока, ние сме винаги насреща за
            разговор и планиране заедно.
          </p>
        </div>
      )}
      {isMobile && (
